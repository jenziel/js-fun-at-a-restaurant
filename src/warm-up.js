...
//     } else {shouldOrderMore = false}

//ternary operator example: (final answer)
...
//Rubber ducking:
//Here I am declaring the variable stockCount and assigning it to the variable inStock.  
var stockCount = inStock

console.log('stockCount: ', stockCount)
stockCount >= 1 ? (console.log(`I'm going to eat some ${food}`)) : (console.log(`We need to get some more ${food}`))
...
if (isFavorite == true) {
    console.log('isFavorite is true: ', `My favorite food is ${food}!`) 
}  else {
    console.log('isFavorite not true: ', `I recently ate ${food}.`)
}
...
var vegetables = ['broccoli', 'celery', 'cauliflower', 'eggplant', 'beet']


// Write the code to access the 3rd element of the Array, using bracket
// notation.
vegetables[2]
console.log('access third element: ', vegetables[2])

// Create a new variable "fruits" and assign it to an Array of 7
// different fruits.
var fruits = ['kiwi', 'mango', 'strawberry', 'raspberry', 'apple', 'banana', 'pineapple']
...
fruits[4]
console.log('access 5th element: ', fruits[4])
//------------------------- Objects -------------------------//
...
// it would make sense to add hoursOpen  

// Write the code to add the key of location, with the value of 'Denver, Colorado'. Use dot
// notation to do this. DO NOT modify your code from above
groceryStore.location = 'North Andover, MA'
console.log('groceryStore: ', groceryStore)